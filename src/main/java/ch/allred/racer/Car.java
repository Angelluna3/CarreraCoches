...
public boolean hasCrossedFinish() {
    return crossedFinish;
}

public void setCrossedFinish(boolean crossedFinish) {
    this.crossedFinish = crossedFinish;
}
  ...
  public Car(int x, int y, int carIndex) {
    ...
    if (carIndex == 1) {
        ...
        rightKeyCode = KeyEvent.VK_D;
         ...
         System.out.println("TERCER CARRO CONFIGURADO");
        forwardKeyCode = KeyEvent.VK_I;
        backwardKeyCode = KeyEvent.VK_K;
        leftKeyCode = KeyEvent.VK_J;
        rightKeyCode = KeyEvent.VK_L;
    }
}
